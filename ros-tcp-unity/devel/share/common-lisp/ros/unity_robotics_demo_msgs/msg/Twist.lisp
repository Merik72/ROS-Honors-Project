...
(cl:defclass <Twist> (roslisp-msg-protocol:ros-message)
  ((linear
    :reader linear
    :initarg :linear
    :type unity_robotics_demo_msgs-msg:Vector3
    :initform (cl:make-instance 'unity_robotics_demo_msgs-msg:Vector3))
   (angular
    :reader angular
    :initarg :angular
    :type unity_robotics_demo_msgs-msg:Vector3
...
(cl:defmethod cl:initialize-instance :after ((m <Twist>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_robotics_demo_msgs-msg:<Twist> is deprecated: use unity_robotics_demo_msgs-msg:Twist instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <Twist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:linear-val is deprecated.  Use unity_robotics_demo_msgs-msg:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <Twist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:angular-val is deprecated.  Use unity_robotics_demo_msgs-msg:angular instead.")
  (angular m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Twist>)))
  ...
  "unity_robotics_demo_msgs/Twist")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Twist)))
  "Returns string type for a message object of type 'Twist"
  "unity_robotics_demo_msgs/Twist")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Twist>)))
  ...
  (cl:format cl:nil "Vector3 linear~%Vector3 angular~%================================================================================~%MSG: unity_robotics_demo_msgs/Vector3~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Twist)))
  "Returns full string definition for message of type 'Twist"
  (cl:format cl:nil "Vector3 linear~%Vector3 angular~%================================================================================~%MSG: unity_robotics_demo_msgs/Vector3~%float64 x~%float64 y~%float64 z~%~%"))
